...
- `generate()` --calls--> `generate_answer()`  [INFERRED]
  D:\Projects & Stuff\niche_finetuned_model\src\api.py → D:\Projects & Stuff\niche_finetuned_model\src\inference.py
- `load_fastapi_dataset()` --calls--> `main()`  [INFERRED]
  D:\Projects & Stuff\niche_finetuned_model\src\dataset.py → D:\Projects & Stuff\niche_finetuned_model\src\train_lora.py
- `build_prompt()` --calls--> `generate_answer()`  [INFERRED]
  D:\Projects & Stuff\niche_finetuned_model\src\dataset.py → D:\Projects & Stuff\niche_finetuned_model\src\inference.py
...
- **Why does `build_prompt()` connect `Community 2` to `Community 1`, `Community 5`?**
